...
import { FaBaby, FaChild, FaUserGraduate, FaUserTie, FaMedal, FaClock, FaUsers, FaCheckCircle } from 'react-icons/fa';
...
const CourseCard = ({ 
  ...
  return (
    <motion.div
      ref={ref}
      className={`bg-white rounded-lg shadow-md overflow-hidden border-t-4 ${color} h-full`}
    ...
    >
      <div className="p-6">
        <div className="flex items-center mb-6">
          <div className={`p-3 rounded-full mr-4 ${color.replace('border', 'bg')}`}>
