...
const RegistrationSection = () => {
  ...
  // Either remove isSubmitting if not needed, or use it in your loading state UI
                  ...
                  <form onSubmit={handleSubmit}>
                          ...
                          <motion.div variants={itemVariants} className="mt-6">
                            <label className="flex items-center">
                              <input
                                type="checkbox"
                                name="acceptTerms"
                                className="rounded border-gray-300 text-secondary focus:ring-secondary h-5 w-5"
                    ...
                    <div className="px-6 py-4 bg-gray-50 flex justify-between">
                      ...
                      <button
                        ...
                        className={`px-6 py-2 text-white rounded-lg transition-colors ${isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-secondary hover:bg-secondary/90'}`}
                      >
